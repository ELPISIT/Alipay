package com.alipay.crossborderwebsitepaymentnotifyverify.util;
...
import com.alipay.crossborderwebsitepaymentnotifyverify.config.AlipayConfig;
import com.alipay.crossborderwebsitepaymentnotifyverify.sign.MD5;
...
public class AlipaySubmit {
     ...
     * @param strMethod 提交方式。两个值可选：post、get  request form.support wo types:post and get
