...
<body>
    <div class="header">
        <div class="container black">
            <div class="qrcode">
                <div class="littlecode">
                    <img width="16px" src="crossborderwappaymentimg/little_qrcode.jpg" id="licode">
                    <div class="showqrs" id="showqrs">
                        <div class="shtoparrow"></div>
                        <div class="guanzhuqr">
                            <img src="crossborderwappaymentimg/guanzhu_qrcode.png" width="80">
                            <div class="shmsg" style="margin-top:5px;">
                            请扫码关注(pls scan to follow)
                            </div>
                            <div class="shmsg" style="margin-bottom:5px;">
                                接收重要信息(accept important infor)
                            </div>
                        </div>
                    </div>
                </div>      
        ...
        <div class="container">
            <div class="nav">
                <a href="https://www.alipay.com/" class="logo"><img src="crossborderwappaymentimg/alipay_logo.png" height="30px"></a>
                <span class="divier"></span>                
            </div>
        </div>
        <div class="container blue">
            <div class="title">支付宝境外收单(create_forex_trade_wap)</div>
        </div>
    </div>
    <div class="content">
        <form action="crossborderwappaymentnotifyverify_alipayapi.jsp" class="alipayform" method="POST" target="_blank">
            <div class="elementtitle" style="margin-top:30px;margin-bottom:30px;margin-left:130px;">
            ...
            <div class="element">
                ...
                <br>
                <div class="mark">注意：商户订单号(out_trade_no).必填(建议是英文字母和数字,不能含有特殊字符)，且确保唯一
                Note：the merchant order number(out_trade_no).Required(suggestion:English letters and Arabic number,no special characters permitted)，be sure it's unique</div>
            ...
            <div class="element">
                ...
                <br>
                <div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)
		Remarks：It is the product name. No special characters.</div>
            </div>
            <div class="element">
                <div class="etitle">Currency:</div>
                <div class="einput"><input type="text" name="WIDcurrency" value="USD"></div>
                <br>
                <div class="mark">注意：外币币种必填，为支付宝支持的14种外币之一，且商户已签约
		Remarks: Settlement currency that merchants signed with Alipay, like USD</div>
            </div>
            <div class="element">
                <div class="etitle">Total_fee:</div>
                <div class="einput"><input type="text" name="WIDtotal_fee" value="0.01"></div>
                <br>
                <div class="mark">注意：付款金额(total_fee/rmb_fee)，必填(格式如：1.00,请精确到分)
		Remarks: The product price in settlement currency</div>
            </div>
			<div class="element">
                <div class="etitle">Body:</div>
                <div class="einput"><input type="text" name="WIDbody" value="test"></div>
                <br>
                <div class="mark">注意：商品描述(body)，选填(建议中文，英文，数字，不能含有特殊字符)
		Remarks: It is the description of the product. Optional.</div>
            </div>
            <div class="element">
                <div class="etitle">product_code:</div>
                <div class="einput"><input type="text" name="WIDproduct_code" value="NEW_WAP_OVERSEAS_SELLER"></div>
                <br>
                <div class="mark">注意：必传，PC端是NEW_OVERSEAS_SELLER，移动端是NEW_WAP_OVERSEAS_SELLER
		Remarks:Mandatory.For PC: NEW_OVERSEAS_SELLER ;FOR WAP and APP: NEW_WAP_OVERSEAS_SELLER</div>
            </div>
            <div class="element">
