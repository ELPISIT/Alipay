        ...
        <form name=alipayment action=barcodepaymentrefund_alipayapi.jsp method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dt>alipay_trans_id：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDalipay_trans_id" />
						<span>The transaction Id on the partner system which could be a sale order id and payment order id.
</span>
					</dd>
					<dt>partner_refund_id：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDpartner_refund_id"/>
						<span>The refund Id on the partner system which could be a sale order id and payment order id.
</span>
					</dd>
					<dt>currency：</dt>
					<dd>
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDrefund_amount" value="0.01"/>
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDrefund_reason" value="This is a test."/>
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDis_sync" value="N"/>
