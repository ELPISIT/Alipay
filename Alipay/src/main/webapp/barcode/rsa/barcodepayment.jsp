...
<%@ page import="com.alipay.barcodepayment.config.*"%>
				...
				<div class="container">
					...
					<table class="table table-striped">
						...
						<tr>
							...
							<td class="value"><input class="form-control" type="text" name="WIDalipay_seller_id" value="2088621896826491" /></td>
							<td class="dscription">Same value with partner ID</td>
						</tr>
						<tr>
							<td class="parameter">trans_name</td>
							<td class="value"><input class="form-control" type="text" name="WIDtrans_name" value="1" /></td>
						...
						<tr>
							...
							<td class="value"><input class="form-control" type="text" name="WIDtrans_create_time" value="20170405164000" /></td>
						...
						<tr>
							...
							<td class="value"><input class="form-control" type="text" name="WIDsecondary_merchant_name" value="Lotte" /></td>
						...
						<tr>
							...
							<td class="value"><input class="form-control" type="text" name="WIDstore_name" value="McDonald in 966 3rd Ave, New York" /></td>
