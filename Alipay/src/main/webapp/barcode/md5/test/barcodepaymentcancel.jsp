        ...
        <form name=alipayment action=barcodepaymentcancel_alipayapi.jsp method=post target="_blank">
			<div class="container">
				...
				<table class="table table-striped">
					...
					<tr>
						<td class="parameter">trade_no</td>
						<td class="value"><input class="form-control" type="text" name="WIDtrade_no"/></td>
						<td class="dscription">The trade serial number of the trade in Alipay system. 16 bits at least and 64 bits at most. If out_trade_no and  trade_no are transmitted at the same time, trade_no shall govern.</td>
					</tr>
					</tbody>
				</table>
